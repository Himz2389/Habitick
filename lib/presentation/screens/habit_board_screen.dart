...
import 'package:habit_flow/presentation/screens/reorder_habits_screen.dart';
...
class _HabitBoardScreenState extends ConsumerState<HabitBoardScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addObserver(
      this,
    ); // 🚨 NAYA: Lifecycle track karne ke liye observer joda
  }
  ...
  void dispose() {
    WidgetsBinding.instance.removeObserver(
      this,
    ); // 🚨 NAYA: Screen se bahar jaane par observer saaf kiya
    super.dispose();
  }
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (state == AppLifecycleState.resumed) {
      ...
      if (now.day != _lastActiveDate.day ||
  ...
  Widget build(BuildContext context) {
    final habits = ref
        .watch(habitProvider)
        .where((habit) => habit.isCompleted == 0 && habit.isDeleted == 0)
        .toList();
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Theme.of(
          context,
        ).colorScheme.primary, // App ki theme ka primary color lega
        foregroundColor: const Color(
          0xFFFFFFFF,
        ), // Icon ka color white kar dega
        elevation: 6, // Thoda shadow dega jisse ye float karta hua lagega
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(
            16,
          ), // Thoda modern squircle (rounded) shape
        ),
                    ...
                    builder: (context) {
                      ...
                      if (firstDate.year == lastDate.year) {
                        if (firstDate.month == lastDate.month) {
                          ...
                          monthYearText =
                              '$firstMonth-$lastMonth, ${firstDate.year}';
                        }
                      } else {
                        final lastYearShort = lastDate.year
                            .toString()
                            .substring(2);
                        monthYearText =
                            '$firstMonth-$lastMonth, ${firstDate.year}-$lastYearShort';
                      }
                                      ...
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: last7Days.map((date) {
                                            ...
                                            bool isActiveDay = habit.activeDays
                                            ...
                                            for (String log
                                              ...
                                              if (parts.isNotEmpty &&
                                                ...
                                                if (!currentColumnDate.isBefore(
                                                      startDate,
                                                    ) &&
                                                    currentColumnDate.isBefore(
                                                      endDate,
                                                    )) {
                                                  isDatePaused = true;
                                                  break;
                                            ...
                                            final dateCompletions =
                                                completionsList
                                                    ...
                                                    .toList();
                                            final currentCompletionObj =
                                                dateCompletions.isNotEmpty
                                                ? dateCompletions.first
                                                : null;

                                            int currentCount =
                                                currentCompletionObj
                                                    ?.isCompleted ??
                                                0;
                                            ...
                                            if (isDatePaused || !isActiveDay) {
                                              return Container(
                                                ...
                                                child: Tooltip(
                                                  message: isDatePaused
                                                      ? 'Habit was paused on this day'
                                                      : 'Not an active day',
                                                  child: Text(
                                                    '-',
                                                    style: TextStyle(
                                              ...
                                              onTap: () {
                                                if (isPaused) {
                                                  ScaffoldMessenger.of(
                                                    ...
                                                    const SnackBar(
                                                      content: Text(
                                                        'This habit is paused. Resume to track!',
                                                      ),
                                                      duration: Duration(
                                                        seconds: 1,
                                                      ),
  ...
  void _showHabitOptions(
    ...
    List<HabitModel> categoryHabits,
  ) {
      ...
      builder: (context) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: const Icon(Icons.reorder, color: Colors.orange),
              title: const Text("Re-ordered Habits"),
              onTap: () async {
                if (categoryHabits.length < 2) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        "Add one more habit to rearrange this category.",
                      ),
                    ),
                  );
                      ...
                      TextButton(
                        onPressed: () {
                          ref
                              ...
                              .updateHabit(habit.copyWith(isDeleted: 1));
                          Navigator.pop(context);
                        },
                        child: const Text(
                          'Delete',
